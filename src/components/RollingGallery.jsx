...
import PostCard from "../assets/PostCard_WNKD.jpg";
import PersonHead from "../assets/travis-blue.jpg";
import ToteBag from "../assets/Tote2.jpeg";
      ...
      <div className="flex h-full items-center justify-center [perspective:1000px] [transform-style:preserve-3d]">
        ...
        >
          {images.map((url, i) => (
            <div
              key={i}
              className="group absolute flex h-fit items-center justify-center p-[8%] [backface-visibility:hidden] md:p-[6%] px-3"
              style={{
                width: `${faceWidth}px`,
